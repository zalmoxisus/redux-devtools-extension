...
export default ({ options, saveOption, saveUrls }) => (
  <div>
    <div className="option option_type_select option_value_left-monitor">
      ...
      <Monitors elementClassName="option__element" type="side" value={options.leftMonitor}
    ...
    <div className="option option_type_select option_value_right-monitor">
      ...
      <Monitors elementClassName="option__element" type="side" value={options.rightMonitor}
    ...
    <div className="option option_type_select option_value_bottom-monitor">
      ...
      <Monitors elementClassName="option__element" type="bottom" value={options.bottomMonitor}
    ...
    <div className="option option_type_input option_value_limit">
      ...
      <input className="option__element" id="limit" type="text" value={options.limit} onChange={saveOption}/>
